...
public class KafkaConfigurationTest {
    ...
    public void shouldLoadProperties() throws IOException {
        ...
        assertThat(kafkaConfiguration.getHostsAddresses())
            .extracting("hostname", "port")
            .containsExactly(tuple("node1", 6062), tuple("node2", 6062));
        ...
        assertThat(kafkaConfiguration.getKafkaConfigMap().get(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG))
            .isEqualTo(JsonObjectSerializer.class.getCanonicalName());
        assertThat(kafkaConfiguration.getKafkaConfigMap().get(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG))
            .isEqualTo(JsonObjectSerializer.class.getCanonicalName());
        ...
        assertThat(kafkaConfiguration.getKafkaConfigMap().get("sasl.jaas.config"))
            .isEqualTo(
                "com.sun.security.auth.module.Krb5LoginModule required useKeyTab=true refreshKrb5Config=true storeKey=true serviceName=\"kafka\" keyTab=\"key.keytab\" principal=\"foo@DOMAIN.COM\";"
            );
